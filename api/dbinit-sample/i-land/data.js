        ...
        codes: [
          {
            ...
            value: "캐릭터",
            depth: 1,
            path: `https://11.fesp.shop/files/${clientId}/category-character.png`,
          },
          {
            sort: 1,
            code: "artist",
            value: "가수/연예인",
            depth: 1,
            path: `https://11.fesp.shop/files/${clientId}/category-artist.png`,
          },
          {
            sort: 1,
            code: "media",
            value: "영화/드라마",
            depth: 1,
            path: `https://11.fesp.shop/files/${clientId}/category-media.png`,
          },
          {
            sort: 1,
            code: "figurines",
            value: "인형/피규어",
            depth: 1,
            path: `https://11.fesp.shop/files/${clientId}/category-figurines.png`,
          },
          {
            sort: 1,
            code: "apparel",
            value: "패션/액세서리",
            depth: 1,
            path: `https://11.fesp.shop/files/${clientId}/category-apparel.png`,
          },
          {
            sort: 1,
            code: "stationery",
            value: "문구/잡화",
            depth: 1,
            path: `https://11.fesp.shop/files/${clientId}/category-stationery.png`,
          },
        ],
      },
      {
